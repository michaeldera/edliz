...
interface IChapterSection {
    short_title: string
    long_title: string
    content: JSX.Element
}
export interface IChapter extends IChapterSection {
    subsections?: IChapterSection[]
}
export interface Contents {
    chapters: IChapterSection[]
    pre: IChapterSection[]
}
...
export const book: IBook = {
    ...
    contents: {
        ...
        pre: [seventh_edition, acknowledgements, foreword, preface, major_highlights],
    },
}
