...
var GithubComponent = styled_components_1.default.div(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n    display: flex;\n    justify-items: baseline;\n    margin: 0 0 150px 50px;\n    text-align: right;\n    img {\n        margin-right: 6px;\n    }\n    small {\n        color: #6c63ff;\n        line-height: 20px;\n        font-size: 14px;\n        letter-spacing: 0.26px;\n        margin: 0;\n    }\n    @media (max-width: 1024px) {\n        display: flex;\n        justify-items: baseline;\n        margin: 0 10px 50px 10px;\n        text-align: center;\n        img {\n            display: none;\n        }\n        small {\n            font-size: 12px;\n            text-align: center;\n            letter-spacing: 0.26px;\n            margin: 0 auto;\n        }\n    }\n"], ["\n    display: flex;\n    justify-items: baseline;\n    margin: 0 0 150px 50px;\n    text-align: right;\n    img {\n        margin-right: 6px;\n    }\n    small {\n        color: #6c63ff;\n        line-height: 20px;\n        font-size: 14px;\n        letter-spacing: 0.26px;\n        margin: 0;\n    }\n    @media (max-width: 1024px) {\n        display: flex;\n        justify-items: baseline;\n        margin: 0 10px 50px 10px;\n        text-align: center;\n        img {\n            display: none;\n        }\n        small {\n            font-size: 12px;\n            text-align: center;\n            letter-spacing: 0.26px;\n            margin: 0 auto;\n        }\n    }\n"])));
var MedicineSM = styled_components_1.default.img(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n    display: none;\n    @media (max-width: 1024px) {\n        display: block;\n        max-width: 60vw;\n        margin: 40px auto;\n        max-height: 20vh;\n    }\n"], ["\n    display: none;\n    @media (max-width: 1024px) {\n        display: block;\n        max-width: 60vw;\n        margin: 40px auto;\n        max-height: 20vh;\n    }\n"])));
var Medicine = styled_components_1.default.img(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n    box-sizing: border-box;\n    padding: 40px;\n    max-width: 40vw;\n    max-height: 40vh;\n    margin-top: 10vh;\n"], ["\n    box-sizing: border-box;\n    padding: 40px;\n    max-width: 40vw;\n    max-height: 40vh;\n    margin-top: 10vh;\n"])));
var Home = function () {
    return (React.createElement(Information_1.MainComponent, null,
        ...
        React.createElement(GithubComponent, null,
            React.createElement("a", { href: "https://github.com/michaeldera/edliz", className: "github-link" },
                React.createElement("img", { src: github_svg_1.default, width: "20", height: "20", alt: "GitHub Icon" })),
